...
public class JdbcLinkRepository implements LinkRepository {
    ...
    public void add(String url, Timestamp updatedAt) {
        ...
        System.out.println(jdbcTemplate.query("select * from link", linkRowMapper));
    ...
    public Optional<Link> findByUrl(String url) {
        Map<String, Object> params = new HashMap<>(
            Map.of("url", url));
        SqlParameterSource paramSource = new MapSqlParameterSource(params);
        System.out.println(jdbcTemplate.query("select * from link where url = :url",
            params, linkRowMapper));
        System.out.println(jdbcTemplate.query("select * from link", linkRowMapper));
        return Optional.ofNullable(
            jdbcTemplate.queryForObject("select * from link where url = :url",
                paramSource, linkRowMapper));
    }
