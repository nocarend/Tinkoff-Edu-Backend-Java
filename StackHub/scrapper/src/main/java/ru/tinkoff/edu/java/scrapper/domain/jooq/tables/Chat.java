...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.TRACK_ID</code>.
     */
    public final TableField<ChatRecord, Long> TRACK_ID = createField(DSL.name("TRACK_ID"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    ...
    /**
     * The column <code>CHAT.LINK_ID</code>.
     */
    public final TableField<ChatRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.BIGINT.nullable(false), this, "");
