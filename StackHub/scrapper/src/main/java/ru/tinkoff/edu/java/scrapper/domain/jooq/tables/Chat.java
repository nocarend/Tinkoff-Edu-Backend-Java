...
public class Chat extends TableImpl<ChatRecord> {
     ...
     */
    public final TableField<ChatRecord, Long> TRACK_ID = createField(DSL.name("TRACK_ID"),
        SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    /**
     * The column <code>CHAT.CHAT_ID</code>.
     */
    public final TableField<ChatRecord, Long> CHAT_ID = createField(DSL.name("CHAT_ID"),
        SQLDataType.BIGINT.nullable(false), this, "");
    /**
     * The column <code>CHAT.LINK_ID</code>.
     */
    public final TableField<ChatRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"),
        SQLDataType.BIGINT.nullable(false), this, "");
