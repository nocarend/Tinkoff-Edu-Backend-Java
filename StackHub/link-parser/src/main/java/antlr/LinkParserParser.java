...
public class LinkParserParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "LinkParser.g4"; }
	...
	public static class LinkContext extends ParserRuleContext {
		...
		public TerminalNode COLON() { return getToken(LinkParserParser.COLON, 0); }
		public List<TerminalNode> SLASH() { return getTokens(LinkParserParser.SLASH); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitLink(this);
	...
	public static class ProtocolContext extends ParserRuleContext {
		public TerminalNode HTTPS() { return getToken(LinkParserParser.HTTPS, 0); }
		public TerminalNode HTTP() { return getToken(LinkParserParser.HTTP, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitProtocol(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ServerContext extends ParserRuleContext {
		...
		public TerminalNode ANY() { return getToken(LinkParserParser.ANY, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitServer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class GitHubContext extends ParserRuleContext {
		public TerminalNode GITHUB() { return getToken(LinkParserParser.GITHUB, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitGitHub(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StackOverflowContext extends ParserRuleContext {
		public TerminalNode STACKOVERFLOW() { return getToken(LinkParserParser.STACKOVERFLOW, 0); }
		public TerminalNode QUESTIONS() { return getToken(LinkParserParser.QUESTIONS, 0); }
		...
		@Override public int getRuleIndex() { return RULE_stackOverflow; }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitStackOverflow(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AnyUsernameContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_anyUsername; }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitAnyUsername(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AnyRepositoryContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_anyRepository; }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitAnyRepository(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class QuestionIdContext extends ParserRuleContext {
		public TerminalNode NUM() { return getToken(LinkParserParser.NUM, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitQuestionId(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AnyQuestionNameContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_anyQuestionName; }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LinkParserVisitor ) return ((LinkParserVisitor<? extends T>)visitor).visitAnyQuestionName(this);
			else return visitor.visitChildren(this);
		}
	}
